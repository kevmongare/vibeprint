...
function App() {
  ...
  return (
    ...
    //Menu bar
      ...
      <h1 className='flex items-center md:text-2xl text-sm font-extrabold text-orange-600'><img src= "" alt="" className='h-20 hidden md:flex' />Vite<span className='text-blue-600'>Print</span></h1>
